...
9. Nexus Repository
10. Jenkins
11. SonarQube et PostgreSQL
12. Intégration Jenkins / SonarQube
13. Intégration Jenkins / Nexus
14. Pipeline CI
15. Publication de l'artefact
16. Gestion des erreurs
17. Captures d'écran
18. Résultat final
19. Objectifs atteints
20. Conclusion
1. Présentation
...
architecture/01-global-architecture.png
...
Le pom.xml contient la configuration permettant d'indiquer à Maven le repository de destination.
...
20. Objectifs atteints
 Préparer l'environnement CentOS.
 Installer et vérifier Java.
 ...
 Installer Jenkins.
 Configurer Java 21 pour Jenkins.
 Configurer Maven et Git sur Jenkins.
 Automatiser le build.
 Installer SonarQube.
 Configurer PostgreSQL.
 Intégrer SonarQube avec Jenkins.
 Installer Nexus Repository.
 Configurer Maven avec Nexus.
 Intégrer Nexus avec Jenkins.
